...
destinations = { [-225, 0, 120, -pi/2, 1], [-225, 0, 63, -pi/2, 1], GRIP_CLOSE, [-225, 0, 120, -pi/2, 1]...
                [-220, 0, 120, 0, 1], [-207, 0, 52, 0, 1], GRIP_OPEN, [-225, 0, 120, 0, 1]...
                [-225, 0, 120, -pi/2, 1], [-225, 0, 63, -pi/2, 1], GRIP_CLOSE, [-225, 0, 120, -pi/2, 1]...
                [-102, 0, 120, -pi/2, 1], [-102, 1, 49, -pi/2, 1], GRIP_OPEN, [-100, 0, 120, -pi/2, 1]...
                [-68, 205, 120, -pi/2, 1], [-68, 205, 63, -pi/2, 1], GRIP_CLOSE, [-68, 205, 120, -pi/2, 1]     ...
                [-102, 0, 120, -pi/2, 1], [-102, 1, 75, -pi/2, 1], GRIP_OPEN, [-100, 0, 120, -pi/2, 1]...
                [-150, -150, 120, -pi/2, 1], [-150, -150, 68, -pi/2, 1], GRIP_CLOSE, [-150, -150, 120, -pi/2, 1]...
                [-102, 0, 120, -pi/2, 1], [-97, 1, 108, -pi/2, 1], GRIP_OPEN, [-100, 0, 120, -pi/2, 1]};


destinations = {[-175, 175, 120, 0, 1], [-161, 161, 50, 0, 1], GRIP_CLOSE, [-175, 175, 120, 0, 1]...
                [-175, 175, 120, -pi/2, 1], [-175, 175, 63, -pi/2, 1], GRIP_OPEN, [-175, 175, 120, -pi/2, 1]...

                [-175, -50, 120, -pi/2, 1], [-175, -50, 63, -pi/2, 1], GRIP_CLOSE, [-175, -50, 120, -pi/2, 1]...
                [-175, -50, 120, 0, 1], [-154, -46, 63, 0, 1], GRIP_OPEN, [-175, -50, 120, 0, 1]...
                
                [-175, -50, 120, -pi/2, 1], [-175, -50, 63, -pi/2, 1], GRIP_CLOSE, [-175, -50, 120, -pi/2, 1]...
                [-175, -50, 120, 0, 1], [-154, -46, 63, 0, 1], GRIP_OPEN, [-175, -50, 120, 0, 1]...
                
                [0, -175, 120, -pi/2, 1], [0, -175, 65, -pi/2, 1], GRIP_CLOSE, [0, -175, 120, -pi/2, 1]...
                [0, -175, 120, 0, 1], [0, -161, 53, 0, 1], GRIP_OPEN, [0, -175, 120, 0, 1]};

destinations = {[-175, 175, 120, 0, 1], [-161, 161, 50, 0, 1], GRIP_CLOSE, [-175, 175, 120, 0, 1]...
                [-175, 175, 120, -pi/2, 1], [-175, 175, 63, -pi/2, 1], GRIP_OPEN, [-175, 175, 120, -pi/2, 1]...
                [-175, 175, 120, 0, 1], [-161, 161, 50, 0, 1], GRIP_CLOSE, [-175, 175, 120, 0, 1]...
                [-104.8, 104.8, 120, -pi/2, 1], [-104.8, 104.8, 49, -pi/2, 1], GRIP_OPEN, [-104.8, 104.8, 120, -pi/2, 1]...

                [-175, -50, 120, -pi/2, 1], [-175, -50, 63, -pi/2, 1], GRIP_CLOSE, [-175, -50, 120, -pi/2, 1]...
                [-104.8, 104.8, 120, -pi/2, 1], [-104.8, 104.8, 75, -pi/2, 1], GRIP_OPEN, [-104.8, 104.8, 120, -pi/2, 1]...

                [0, -175, 120, -pi/2, 1], [0, -175, 65, -pi/2, 1], GRIP_CLOSE, [0, -175, 120, -pi/2, 1]...
                [-104.8, 104.8, 120, -pi/2, 1], [-104.8, 104.8, 108, -pi/2, 1], GRIP_OPEN, [-104.8, 104.8, 120, -pi/2, 1]};
