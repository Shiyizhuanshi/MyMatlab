...
% should have two non-fixed joints, where the link bodies are connected to
% their parent bodies via a revolute joint, and the end effector is
% connected to its parent body via a fixed joint.
showdetails(robot)
